...
@Table(name = "EMPLOYEE")
public class EmployeeWithoutEntity implements EmplInterface{
    @Id
    @Column(name = "id")
    private int id;
    ...
    public EmployeeWithoutEntity() {
    }

    public EmployeeWithoutEntity(String fname, String lname, int salary) {
	...
	if (getClass() != obj.getClass())
	    return false;
	EmployeeWithoutEntity other = (EmployeeWithoutEntity) obj;
	if (firstName == null) {
